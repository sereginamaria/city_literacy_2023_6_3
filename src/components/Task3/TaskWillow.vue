<template>
    <div class="backgroundTaskCleaningDay"
        ...
        <div class="instruction-block" id="instruction-block">
            <p>Выбери подходящий вариант ответа.
            </p>
        </div>
        <div class="d-flex justify-content-center align-items-center w-100"
             :style="'height: calc(100% - ' + this.height + 'px)'">
            <div class="option-answers-background">
                <div v-for="el in constTaskCleaningDay.listOfAnswersWillow" :key="el.id" :class="{choosenAnswer: el.id === mainJSON.taskCleaningDay.results.ULSE3_Log_SES4}"
        ...
        <div class="background-text" id="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.taskCleaningDay.results.ULSE3_Log_SES4 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.taskCleaningDay.results.ULSE3_Log_SES4 = el.id
            },
            checkAnswer() {
                screen.isShow = false
                ...
                if (this.mainJSON.taskCleaningDay.results.ULSE3_Log_SES4 === 2){
                    this.mainJSON.taskCleaningDay.results.ULSE3_Score_SES4 = 1
                }
                else this.mainJSON.taskCleaningDay.results.ULSE3_Score_SES4 = 0
                let t = new Date()
