    ...
    <div class="backgroundTaskCleaningDay"
        ...
        <div class="d-flex justify-content-center align-items-center w-100"
            ...
            <div class="option-answers-background">
                <div v-for="el in constTaskCleaningDay.listOfAnswersBusStop" :key="el.id" :class="{choosenAnswer: el.id === mainJSON.taskCleaningDay.results.ULSE3_Log_SES5}"
        ...
        <div class="background-text" id="background-text">
            ...
            <MyButton class="white-buttons" @click="checkAnswer" v-if="mainJSON.taskCleaningDay.results.ULSE3_Log_SES5 !== 'NA'">Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.taskCleaningDay.results.ULSE3_Log_SES5 = el.id
            },
            checkAnswer() {
                screen.isShow = false
                ...
                if (this.mainJSON.taskCleaningDay.results.ULSE3_Log_SES5 === 1){
                    this.mainJSON.taskCleaningDay.results.ULSE3_Score_SES5 = 1
                }
                else this.mainJSON.taskCleaningDay.results.ULSE3_Score_SES5 = 0
                let t = new Date()
