    ...
    <div class="background backgroundTaskScienceFestival" :style="{ background: 'url(' + require('../../assets/' + screen.imgURL + '.webp') + ')'}">
        ...
        <div class="background-task1">
            <div style="line-height: 3; text-align: justify; font-size: 18px" id="collapseModularTask4">
                ...
                <span data-bs-toggle="collapse" data-bs-target="#collapseWorkBookQ1" aria-expanded="false" aria-controls="collapseWorkBookQ1"
                      @click="openWorkBookQ(14)" style="text-decoration: underline; font-size: 18px" :class="{colorAnswers: this.mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_1 === 'NA'}"
                >{{this.mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_1 !== "NA" ? mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_1 : "_______"}}</span>
                ...
                <span data-bs-toggle="collapse" data-bs-target="#collapseWorkBookQ2" aria-expanded="false" aria-controls="collapseWorkBookQ2"
                      @click="openWorkBookQ(15)" style="text-decoration: underline; font-size: 18px; font-size: 18px" :class="{colorAnswers: this.mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_2 === 'NA'}"
                >{{this.mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_2 !== "NA" ? mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_2 : "_______"}}</span>.
                ...
                <span data-bs-toggle="collapse" data-bs-target="#collapseWorkBookQ3" aria-expanded="false" aria-controls="collapseWorkBookQ3"
                      @click="openWorkBookQ(16)" style="text-decoration: underline; font-size: 18px" :class="{colorAnswers: this.mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_3 === 'NA'}"
                >{{this.mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_3 !== "NA" ? mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_3 : "_______"}}</span>.
        ...
        <div class="background-task2" v-if="mainJSON.taskScienceFestival.modularTask1_17Show">
            ...
            <div style="background: #fff; border: 1px solid #54bedf;" class="mt-2">
                <div v-for="el in constTaskScienceFestival.listOfAnswersTaskWorkBook4" :key="el.id" :class="{choosenAnswer: el.id === mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_4}"
        ...
        <div class="background-text justify-content-end" style="background: none; justify-content: end;">
            <MyButton class="white-buttons" @click="checkAnswer"
                      v-if="mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_1 !== 'NA' || mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_2 !== 'NA'
                      || mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_3 !== 'NA' || mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_4 !== 'NA'"
            >
                Готово</MyButton>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            chooseAnswer(el){
                this.mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_4 = el.id
                this.mainJSON.taskScienceFestival.ULSCLL3_Log_LLK1_4 = el.value
                this.mainJSON.taskScienceFestival.modularTask1_17Show = false
            },
            chooseWorkBookEl(workBookID, id, el){
                this.mainJSON.taskScienceFestival.results["ULSCLL3_Log_LLK1_" + workBookID] = el.id

                if(workBookID === 1){
                    if(el.value === 'В 1100 году'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = '1100'
                    }
                    if(el.value === 'В 1177 году'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = '1177'
                    }
                    if(el.value === 'В 1147 году'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = '1147'
                    }
                    if(el.value === 'В 1240 году'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = '1240'
                    }
                }
                if(workBookID === 2){
                    if(el.value === 'Князь Даниил Московский'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = 'Князем Даниилом Московским"'
                    }
                    if(el.value === 'Князь Александр Невский'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = 'Князем Александром Невским'
                    }
                    if(el.value === 'Князь Владимир Мономах'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = 'Князем Владимиром Мономахом'
                    }
                    if(el.value === 'Князь Юрий Долгорукий'){
                        this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = 'Князем Юрием Долгоруким'
                    }
                }
                if(workBookID === 3 || workBookID === 4){
                    this.mainJSON.taskScienceFestival["ULSCLL3_Log_LLK1_" + workBookID] = el.value
                }
                this.mainJSON.taskScienceFestival["modularTask1_" + id + "Show"] = false
            },
            openWorkBookQ(id){
                let k = 15
                while (k !== 18){
                    if(k !== id){
                        this.mainJSON.taskScienceFestival["modularTask1_" + k + "Show"] = false
                    }
                    k++
                }
                this.mainJSON.taskScienceFestival["modularTask1_" + id + "Show"] = !this.mainJSON.taskScienceFestival["modularTask1_" + id + "Show"]
            },
            checkAnswer(){
                screen.isShow = false
                ...
                if(this.mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_1 ===  2){
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_1 = 1
                }
                else {
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_1 = 0
                }
                if(this.mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_2 ===  4){
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_2 = 1
                }
                else {
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_2 = 0
                }
                if(this.mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_3 ===  3){
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_3 = 1
                }
                else {
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_3 = 0
                }
                if(this.mainJSON.taskScienceFestival.results.ULSCLL3_Log_LLK1_4 ===  1){
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_4 = 1
                }
                else {
                    this.mainJSON.taskScienceFestival.results.ULSCLL3_Score_LLK1_4 = 0
                }
                let t = new Date()
