...
import constTaskScienceFestival from "./constTaskScienceFestival"
...
export default new Vuex.Store({
    ...
    actions: {
        get_mainJSON({commit}){
            if (!localStorage.login && !localStorage.hash) {
                ...
                commit('set_constTaskScienceFestival', constTaskScienceFestival.constTaskScienceFestival)
    ...
    mutations: {
        ...
        set_constTaskScienceFestival: (state, el) => {
            state.constTaskScienceFestival = el
        },
    ...
    getters: {
        ...
        constTaskScienceFestival(state){
            return state.constTaskScienceFestival;
        },
